...
const SECTION_META: Record<SectionType, SectionMeta> = {
  ...
  certificates:     { icon: Award, description: "Add your certifications" },
  awards:           { icon: Trophy, description: "Add recognitions and achievements" },
  interests:        { icon: Heart, description: "Hobbies and personal interests" },
  publications:     { icon: Book, description: "Add papers, articles and books" },
  organizations:    { icon: Users, description: "Add volunteering and memberships" },
...
export function AddSectionModal({ existingTypes, onAdd, onClose }: Props) {
  ...
  const isClickable = (t: SectionType) => !existingTypes.has(t);
                ...
                <button
                  ...
                  className={cn(
                    ...
                    clickable
                      ...
                      : "border-[#21262d] opacity-40 cursor-not-allowed"
                  )}
                >
                  <div className={cn(
