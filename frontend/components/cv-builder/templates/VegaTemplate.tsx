...
// CorporateTemplate.tsx's CORPORATE_SIDEBAR_TYPES.
export const VEGA_SIDEBAR_TYPES = new Set(["education", "skills", "soft_skills", "certificates", "languages", "interests"]);
const SIDEBAR_TYPES = VEGA_SIDEBAR_TYPES;
...
export function VegaTemplate({ sections, customization = DEFAULT_CUSTOMIZATION }: Props) {
  ...
  return (
    <div className="vega-outer" style={{ backgroundColor: "#fff", fontSize: 12, color: MID, lineHeight: 1.6, fontFamily: fontCSS, minHeight: "297mm" }}>
